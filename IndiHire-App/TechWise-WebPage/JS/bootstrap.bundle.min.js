 ...
 */
document.getElementById("hoverLink").addEventListener("mouseover", () => {
  let arrow = document.getElementById("arrowChange");
  arrow.setAttribute("src", "./Images/redirect-white-arrow.png");
});
document.getElementById("hoverLink").addEventListener("mouseout", () => {
  let arrow = document.getElementById("arrowChange");
  arrow.setAttribute("src", "./Images/black-arrow.png");
});
!(function (t, e) {
